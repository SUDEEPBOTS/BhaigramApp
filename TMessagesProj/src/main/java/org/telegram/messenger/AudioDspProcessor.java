...
public class AudioDspProcessor {
    ...
    public static void applyPreset(int preset) {
        switch (preset) {
            ...
            case 2: // Vocal Treble Pierce
                ...
                setBandGain(9, 14.0f);
                break;
            case 3: // Maximum Overdrive (+28dB Gain Boost)
                setMasterGainDb(28.0f);
                for (int i = 0; i < 10; i++) setBandGain(i, 10.0f);
                break;
        }
    }
    ...
    public static void showDspControlDialog(Context context, Runnable onUpdate) {
        ...
        String[] options = new String[]{
            ...
            "Preset: Maximum Overdrive (+28dB Boost)"
        };
        ...
        builder.setItems(options, (dialog, which) -> {
            ...
            switch (which) {
                ...
                case 5:
                    setStudioModeEnabled(true);
                    applyPreset(3);
                    Toast.makeText(context, "Applied Preset: Maximum Overdrive (+28dB Boost)", Toast.LENGTH_LONG).show();
                    break;
            }
